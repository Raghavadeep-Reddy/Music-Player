 ...
 */
// it will be used for hashing in between linked list and for playlist purpose
 struct song {
    int songid;
    string name;
    int counter;
    string artistname;
    bool love;
    struct ids *head_for_playlist;
    // this pointer will point to playlist's in which the song is being included
    struct song *prev,*next;
    song(string name,string artist,int idd){
        this->songid=idd;
        this->name=name;
        this->head_for_playlist=NULL;
...
class hash_table{ // just for hashing for songs all three have same framework
private :
    int size_for_hash=5;
...
/*
class hash_table_playlist{ // just for hashing for playlist
    private :
    int size_for_hash=5;
    song  *address[50]={NULL} ; //it can handle 500 * 50 songs = 25000 songs
public:
...
class hash_table_songs_in_playlist{ // just for hashing for songs in playlist
    private :
    int size_for_hash=5;
    song  *address[50]={NULL} ; //it can handle 500 * 50 songs = 25000 songs
public:
